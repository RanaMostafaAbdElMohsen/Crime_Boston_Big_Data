...
public class MonthMaxCrimes {
    public static void main(String[] args) throws Exception {
        ...
        DataSource<Tuple1<String>> csvInput = env.readCsvFile("/home/omnia/Crime_Boston_Big_Data/crime-boston/src/main/java/crimes-in-boston/crime.csv")
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .includeFields("00000000010000000")
                .types(String.class);
        ...
        DataSet<Tuple2<String,Integer>> out2 = crimes_per_year
                .minBy(1);



//        final ParameterTool params = ParameterTool.fromArgs(args);
        //  crimes_per_year.writeAsCsv(out_path+"crimes_per_year");
        //  env.execute("Crimes Frequency in Year");
