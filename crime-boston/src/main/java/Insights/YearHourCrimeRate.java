...
public class YearHourCrimeRate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSource<Tuple2<String, String>> csvInput = env.readCsvFile(path)
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .includeFields("00000000100100000")
                .types(String.class, String.class);

        GroupReduceOperator<Tuple2<String, String>, Tuple3<String, String, Integer>> crimes_count_rate_per_hour_per_year =
                csvInput.filter(new YearMonthCrimeRate.district_filter_())
                        .groupBy(1,0)

                        .reduceGroup(new YearMonthCrimeRate.month_per_year_count_());

        crimes_count_rate_per_hour_per_year.writeAsCsv(out_path+"crimes_count_rate_per_hour_per_year");
        env.execute("crimes_count_rate_per_hour_per_year");
        System.out.println("Printing result to stdout. Use --output to specify output path.");
        crimes_count_rate_per_hour_per_year.print();
    }
    ...
    public static class month_per_year_count_ implements GroupReduceFunction<Tuple2<String ,String>, Tuple3<String ,String, Integer>> {
        ...
        public void reduce(Iterable<Tuple2<String, String>> records, Collector<Tuple3<String, String, Integer>> out) throws Exception {
            ...
            out.collect(new Tuple3<>(year,hour,cnt));
        }
    }
}
