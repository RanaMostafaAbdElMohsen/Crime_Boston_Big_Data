...
// set up the batch execution environment
        ...
        DataSource<Tuple1<String>> csvInput = env.readCsvFile("/home/omnia/Crime_Boston_Big_Data/crime-boston/src/main/java/crimes-in-boston/crime.csv")
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .includeFields("00000000001000000")
                .types(String.class);
        ...
        DataSet<Tuple2<String, Integer>> crimes_per_day =
                ...
                csvInput.flatMap(new Tokenizer())
                        ...
                        .groupBy(0)
                        .sum(1);
        DataSet<Tuple2<String,Integer>> out2 = crimes_per_day
                .minBy(1);


//        final ParameterTool params = ParameterTool.fromArgs(args);
      //  crimes_per_day.writeAsCsv(out_path + "crimes_per_day");
       // env.execute("Crimes Frequency in Day");
