...
public class safest_district {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSource<Tuple1<String>> csvInput = env.readCsvFile(path)
                .ignoreFirstLine()
                .includeFields("00001000000000000")
                .parseQuotedStrings('"')
                .types(String.class);

        ReduceOperator<Tuple2<String, Integer>> get_safe_district =
        ...
        get_safe_district.writeAsCsv(out_path+"Safest_district");
        env.execute(" Safest District");
//        System.out.println("Printing result to stdout. Use --output to specify output path.");
//        get_safe_district.print();
    ...
    public static final class Tokenizer implements FlatMapFunction<Tuple1<String>, Tuple2<String, Integer>> {
        ...
        public void flatMap(Tuple1<String> value, Collector<Tuple2<String, Integer>> out) throws Exception {
            ...
            // emit the pairs
                ...
                if (tokens.length() > 2 && tokens !=" " &&   tokens !="" && tokens !="()") {
